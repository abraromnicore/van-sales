...
import { CardFooter } from '@components/dialog/CardFooter';
import { Link } from 'react-router-dom';
import { Eye, Menu, Pencil, Plus } from 'lucide-react';
...
export const DriverUsers = () => {
  ...
  return (
    <>
      ...
      <DialogCard onHide={() => setShowEditUser(false)} visible={showEditUser}>
        <DialogHeader
