...
const SupervisorDashboard: React.FC = () => {
    const teamData: TeamMember[] = [
        { id: 1, name: "Ahmad Hassan", visits: 28, totalVisits: 30, productivity: 93.3, revenue: 15420, rank: 1, status: 'active' },
        { id: 2, name: "Sarah Ali", visits: 25, totalVisits: 28, productivity: 89.3, revenue: 13850, rank: 2, status: 'active' },
        { id: 3, name: "Omar Khan", visits: 22, totalVisits: 26, productivity: 84.6, revenue: 12100, rank: 3, status: 'break' },
        { id: 4, name: "Fatima Sheikh", visits: 20, totalVisits: 25, productivity: 80.0, revenue: 11200, rank: 4, status: 'active' }
    ];
    ...
    const CircularProgress: React.FC<{
        ...
        strokeWidth?: number;
        color?: string;
    }> = ({ percentage = 10, size = 140, strokeWidth = 12, color = '#4f46e5' }) => {
    ...
    const getNotificationStyles = (type: string, priority: string) => {
        const baseStyles = "flex items-start space-x-3 p-4 rounded-xl border transition-all duration-200 hover:shadow-sm cursor-pointer";
        ...
        return `${baseStyles} ${typeStyles[type as keyof typeof typeStyles]} ${priorityBorder}`;
    };
    ...
    const getNotificationIcon = (type: string) => {
        ...
        return iconMap[type as keyof typeof iconMap] || <Bell className="h-5 w-5 text-slate-500" />;
    };
                ...
                <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                            ...
                            <div className="mt-4">
                                <p className="text-sm font-medium text-slate-600 mb-1">Active Reps</p>
                        ...
                        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-2xl sm:text-3xl font-bold text-slate-900">87</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                            ...
                            <div className="mt-4">
                                <p className="text-sm font-medium text-slate-600 mb-1">Routes Active</p>
                        ...
                        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-xl sm:text-2xl font-bold text-slate-900">Rs. 19.5K</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="p-6 border-b border-slate-200">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <h3 className="text-xl font-bold text-slate-900">Today's Sales Performance</h3>
                                                <p className="text-sm text-slate-600 mt-1">Target progress and revenue breakdown</p>
                                            </div>
                                        </div>
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                        <div className="flex justify-center items-center">
                                            <CircularProgress percentage={78} size={180} strokeWidth={16} color="#4f46e5" />
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-center p-4 bg-slate-50 rounded-xl border border-slate-100">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <span className="text-xl font-bold text-slate-900">Rs. 25,000</span>
                                            ...
                                            <div className="flex justify-between items-center p-4 bg-blue-50 rounded-xl border border-blue-100">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <span className="text-xl font-bold text-blue-900">Rs. 19,500</span>
                                            ...
                                            <div className="flex justify-between items-center p-4 bg-indigo-50 rounded-xl border border-indigo-200">
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <span className="text-sm font-semibold text-indigo-700">Today's Sales</span>
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    <span className="text-xl font-bold text-indigo-900">Rs. 5,200</span>
                                                    <div className="flex items-center text-xs text-emerald-600">
                                                        <TrendingUp className="h-3 w-3 mr-1" />
                                                        +8.5%
                                                    </div>
                                            ...
                                            <div className="mt-6 pt-4 border-t border-slate-200">
                                                <div className="flex justify-between text-sm">
                                                    ...
                                                    <span className="font-semibold text-slate-900">Rs. 5,500 (22%)</span>
                                                </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-600">Recent system alerts</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                ...
                                <div className="p-4 max-h-96 overflow-y-auto">
                                    <div className="space-y-3">
                                        {notifications.slice(0, 6).map((notification) => (
                                            <div key={notification.id} className={getNotificationStyles(notification.type, notification.priority)}>
                            ...
                            <div className="p-6 border-b border-slate-200">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-slate-900">Collections Summary</h3>
                                            <p className="text-sm text-slate-600 mt-1">Today's collection breakdown</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center text-sm text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full">
                                        <TrendingUp className="h-4 w-4 mr-1" />
                            ...
                            <div className="p-6 space-y-4">
                                <div className="flex items-center justify-between p-5 bg-emerald-50 rounded-2xl border border-emerald-200">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold text-emerald-700 mb-1">Cash Collections</p>
                                            <p className="text-2xl font-bold text-emerald-900">Rs. 15,240</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs font-medium text-emerald-700 mb-1">62% of total</div>
                                ...
                                <div className="flex items-center justify-between p-5 bg-blue-50 rounded-2xl border border-blue-200">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold text-blue-700 mb-1">Cheque Collections</p>
                                            <p className="text-2xl font-bold text-blue-900">Rs. 8,950</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs font-medium text-blue-700 mb-1">36% of total</div>
                                ...
                                <div className="flex items-center justify-between p-5 bg-amber-50 rounded-2xl border border-amber-200">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold text-amber-700 mb-1">Pending Collections</p>
                                            <p className="text-2xl font-bold text-amber-900">Rs. 3,120</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs font-medium text-amber-700 mb-1">2% of total</div>
                                ...
                                <div className="mt-6 pt-4 border-t border-slate-200">
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-2xl font-bold text-slate-900">Rs. 27,310</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200">
                            <div className="p-6 border-b border-slate-200">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-slate-900">Returns Overview</h3>
                                            <p className="text-sm text-slate-600 mt-1">Product returns and damages</p>
                                        </div>
                                    </div>
                            ...
                            <div className="p-6 space-y-6">
                                <div className="text-center p-6 bg-slate-50 rounded-2xl border border-slate-200">
                                    ...
                                    <p className="text-sm font-semibold text-slate-600">Total Returns Today</p>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="text-center p-4 bg-red-50 rounded-xl border border-red-200">
                                        <p className="text-xl font-bold text-red-900 mb-1">Rs. 2,840</p>
                                        <p className="text-xs font-semibold text-red-700">Return Value</p>
                                    ...
                                    <div className="text-center p-4 bg-orange-50 rounded-xl border border-orange-200">
                                        ...
                                        <p className="text-xs font-semibold text-orange-700">Damaged Items</p>
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="font-semibold text-slate-700">Most Returned Categories</span>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <span className="text-sm text-slate-700 font-medium">Soft Drinks</span>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                <span className="text-sm font-bold text-slate-900">8 units</span>
                                        ...
                                        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <span className="text-sm text-slate-700 font-medium">Snacks</span>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                <span className="text-sm font-bold text-slate-900">5 units</span>
                                                <div className="w-8 h-2 bg-slate-200 rounded-full">
                                        ...
                                        <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <span className="text-sm text-slate-700 font-medium">Dairy Products</span>
                                            </div>
                                            <div className="flex items-center space-x-2">
                            ...
                            <div className="p-6 border-b border-slate-200">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-slate-900">Team Performance Snapshot</h3>
                                            <p className="text-sm text-slate-600 mt-1">Real-time sales representative performance</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center space-x-3">
                            ...
                            <div className="p-6">
                                <div className="space-y-4">
                                    {teamData.map((member, index) => (
                                        <div key={member.id} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border transition-all duration-200 hover:shadow-md ${index === 0
                                                ? 'bg-gradient-to-r from-amber-50 to-yellow-50 border-amber-200 shadow-sm'
                                                : 'bg-slate-50 border-slate-200 hover:bg-slate-100'
                                            }`}>
                                            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
                                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold shadow-sm ${index === 0 ? 'bg-gradient-to-r from-amber-400 to-yellow-400 text-amber-900 shadow-amber-200' :
                                                        index === 1 ? 'bg-slate-300 text-slate-700 shadow-slate-200' :
                                                            index === 2 ? 'bg-orange-300 text-orange-800 shadow-orange-200' :
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex items-center space-x-3 mb-2">
                                                        ...
                                                        <span className={`text-xs px-2 py-1 rounded-full border font-medium ${getStatusColor(member.status)}`}>
                                                            {member.status}
                                                        </span>
                                                    </div>
                                            ...
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-8">
                                                <div className="grid grid-cols-2 gap-6 sm:flex sm:space-x-8">
                                                    <div className="text-center sm:text-right">
                                                        <p className="text-sm font-semibold text-slate-900 mb-1">{member.productivity}%</p>
                                                        <p className="text-xs text-slate-500 font-medium">Productivity</p>
                                                    </div>
                                                    <div className="text-center sm:text-right">
                                                        <p className="text-sm font-bold text-slate-900 mb-1">Rs. {member.revenue.toLocaleString()}</p>
                                                ...
                                                <div className="w-full sm:w-20">
                                                    <div className="flex items-center justify-between mb-1">
                                                        ...
                                                        <span className="text-xs text-slate-600 font-bold">{member.productivity}%</span>
                                                    </div>
                                                    <div className="w-full bg-slate-200 rounded-full h-3 shadow-inner">
                                                        <div
                                                            className={`h-3 rounded-full transition-all duration-1000 ease-out ${member.productivity >= 90 ? 'bg-gradient-to-r from-emerald-400 to-emerald-500' :
                                                                    member.productivity >= 80 ? 'bg-gradient-to-r from-blue-400 to-blue-500' :
                                                                        member.productivity >= 70 ? 'bg-gradient-to-r from-amber-400 to-amber-500' :
                                ...
                                <div className="mt-6 pt-6 border-t border-slate-200">
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                        <div className="text-center p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                                            <p className="text-2xl font-bold text-emerald-900 mb-1">87.8%</p>
                                            <p className="text-sm font-semibold text-emerald-700">Avg Productivity</p>
                                        </div>
                                        <div className="text-center p-4 bg-blue-50 rounded-xl border border-blue-200">
                                            <p className="text-2xl font-bold text-blue-900 mb-1">95</p>
                                            <p className="text-sm font-semibold text-blue-700">Total Visits</p>
                                        </div>
                                        <div className="text-center p-4 bg-purple-50 rounded-xl border border-purple-200">
                                            <p className="text-2xl font-bold text-purple-900 mb-1">Rs. 52.5K</p>
                                            <p className="text-sm font-semibold text-purple-700">Team Revenue</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div className="bg-white rounded-xl p-4 border border-slate-200 text-center">
                            ...
                            <p className="text-sm text-slate-600 font-medium">Route Completion</p>
                            <div className="mt-2 text-xs text-emerald-600">+2.1% vs yesterday</div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-4 border border-slate-200 text-center">
                            ...
                            <div className="mt-2 text-xs text-emerald-600">+Rs. 18 vs yesterday</div>
                        </div>
