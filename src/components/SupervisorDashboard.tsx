          ...
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-4">
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2">
                  <p className="text-slate-600 text-sm">Monitor team performance and daily operations</p>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="text-right hidden sm:block">
                ...
                <p className="text-lg font-bold text-slate-900">Sep 24, 2025</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="p-6">
              <div className="space-y-4">
                {teamData.map((member, index) => (
                  <div key={member.id} className={`flex flex-col sm:flex-row sm:items-center justify-between p-5 rounded-2xl border transition-all duration-200 hover:shadow-md ${
                    index === 0 
                    ...
                    <div className="flex items-center space-x-4 mb-4 sm:mb-0">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold shadow-sm ${
                        index === 0 ? 'bg-gradient-to-r from-amber-400 to-yellow-400 text-amber-900 shadow-amber-200' :
                        ...
                        <div className="w-full bg-slate-200 rounded-full h-3 shadow-inner">
                          <div 
                            className={`h-3 rounded-full transition-all duration-1000 ease-out ${
                              member.productivity >= 90 ? 'bg-gradient-to-r from-emerald-400 to-emerald-500' :
